...
Page(Object.assign({},templateMethods,{
  data: {
    ...
    var t = this;
    wx.setNavigationBarTitle({title: e.pname || e.cname}), this.setData({
      post: {
        orderby: 1,
        sort: 2,
        pname: e.pname,
    ...
    this.setData({flag: !1});
    var t = this;
    $.xsr($.makeUrl(pdapi.GetProductList, this.data.post), function (n) {
  ...
  onShareAppMessage: function () {
    return {
      title: app.globalData.VendorInfo.ShopName+'分类列表',
      desc: app.globalData.VendorInfo.VendorInfo+'分类列表',
      path: "/pages/search_product/search_product"
    };
  }
}));